...
* A [network plugin](/docs/kubernetes/en/concepts/extend-kubernetes/compute-storage-net/network-plugins/) that supports dual-stack networking.
* [Dual-stack enabled](/docs/kubernetes/en/concepts/services-networking/dual-stack/) cluster
