...
Many of the [examples](/docs/kubernetes/en/reference/kubectl/cheatsheet/) provide an introduction to using
`kubectl`, and complete documentation is found in the
[kubectl reference](/docs/kubernetes/en/reference/kubectl/).
...
for this.  [Controlling Access to the API](/docs/kubernetes/en/concepts/security/controlling-access)
...
There are [client libraries](/docs/kubernetes/en/reference/using-api/client-libraries/) for accessing the API from other languages.
...
Please check [Accessing the API from within a Pod](/docs/kubernetes/en/tasks/run-application/access-api-from-pod/)
for more details.
...
[Access Cluster Services](/docs/kubernetes/en/tasks/access-application-cluster/access-cluster-services/).
...
1.  The [apiserver proxy](/docs/kubernetes/en/tasks/access-application-cluster/access-cluster-services/#discovering-builtin-services):
...
1.  The [kube proxy](/docs/kubernetes/en/concepts/services-networking/service/#ips-and-vips):
