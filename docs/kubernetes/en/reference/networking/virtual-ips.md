...
{{< figure src="/docs/kubernetes/en/images/services-iptables-overview.svg" title="Services overview diagram for iptables proxy" class="diagram-medium" >}}
...
{{< figure src="/docs/kubernetes/en/images/services-ipvs-overview.svg" title="Services overview diagram for IPVS proxy" class="diagram-medium" >}}
