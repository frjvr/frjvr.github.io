...
id: flexvolume
date: 2018-06-25
full_link: /docs/kubernetes/en/concepts/storage/volumes/#flexvolume
short_description: >
...
* [FlexVolume in the Kubernetes documentation](/docs/kubernetes/en/concepts/storage/volumes/#flexvolume)
