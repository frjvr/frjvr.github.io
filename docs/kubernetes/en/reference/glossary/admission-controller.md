...
date: 2019-06-28
full_link: /docs/kubernetes/en/reference/access-authn-authz/admission-controllers/
short_description: >
...
* [Admission controllers in the Kubernetes documentation](/docs/kubernetes/en/reference/access-authn-authz/admission-controllers/)
