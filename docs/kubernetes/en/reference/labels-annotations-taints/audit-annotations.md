...
[enable auditing](/docs/kubernetes/en/tasks/debug/debug-cluster/audit/) in your cluster,
...
[Event API](/docs/kubernetes/en/reference/kubernetes-api/cluster-resources/event-v1/) (API group
`events.k8s.io`).
{{< /note >}}
...
[Pod Security Exemption](/docs/kubernetes/en/concepts/security/pod-security-admission/#exemptions)
...
Standard](/docs/kubernetes/en/concepts/security/pod-security-standards) levels accompanied by
...
See [Pod Security Standards](/docs/kubernetes/en/concepts/security/pod-security-standards/)
...
[Pod Security Standard](/docs/kubernetes/en/concepts/security/pod-security-standards/) level
...
See [Auditing](/docs/kubernetes/en/tasks/debug/debug-cluster/audit/) for more information.
